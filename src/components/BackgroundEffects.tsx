...
export default function BackgroundEffects() {
  ...
  return (
    <div ref={ref} className="fixed inset-0 z-0 overflow-hidden pointer-events-none" aria-hidden>
      <motion.div style={{ y: ySlow, opacity }} className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-[20%] left-0 w-[70%] h-[70%] rounded-full bg-[var(--accent-warm)]/[0.07]" />
      </motion.div>
      <motion.div style={{ y: yMid }} className="absolute inset-0 overflow-hidden">
        <div className="absolute top-[45%] right-0 w-[55%] h-[55%] rounded-full bg-blue-900/[0.04]" />
      </motion.div>
